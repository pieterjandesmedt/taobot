module.exports = {
	...
	translatedBy: 'Geoffrey James',
	books: [{
		title: 'The Silent Void',
		masterProgrammerQuote: 'When you have learned to snatch the error code from the trap frame, it will be time for you to leave.',
		chapters: [
			[
	...
	},
	{
		...
		masterProgrammerQuote: 'After three days without programming, life becomes meaningless.',
		chapters: [
			[
	...
	{
		title: 'Design',
		masterProgrammerQuote: 'When a program is being tested, it is too late to make design changes.',
		chapters: [
			[
	...
	{
		title: 'Coding',
		masterProgrammerQuote: 'A well-written program is its own Heaven; a poorly-written program is its own Hell.',
		chapters: [
			[
	...
	{
		title: 'Maintenance',
		masterProgrammerQuote: 'Though a program be but three lines long, someday it will have to be maintained.',
		chapters: [
			[
	...
	{
		title: 'Management',
		masterProgrammerQuote: 'Let the programmers be many and the managers few -- then all will be productive.',
		chapters: [
			[
	...
	},
	{
		...
		masterProgrammerQuote: 'You can demonstrate a program for a corporate executive, but you can\'t make him computer literate.',
		chapters: [
			[
	...
	},
	{
		...
		masterProgrammerQuote: 'Without the wind, the grass does not move. Without software hardware is useless.',
		chapters: [
			[
	...
	{
		title: 'Epilogue',
		masterProgrammerQuote: 'Time for you to leave.',
		chapters: []
	},
	]
}
